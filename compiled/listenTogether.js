...
module.exports={
    ...
    "version": "0.4.3",
    "scripts": {
        "build": "rm -rf ./dist && tsc && cp ./src/public ./dist/src/ -r && browserify -t browserify-css dist/src/index.js -o dist/src/bundle.js",
        "pushSpotify": "./scripts/pushSpotify.sh",
        "openMultiSpotify": "./scripts/openMultiSpotify.sh"
    },
    "keywords": [],
    "author": "",
    "license": "ISC",
...
const bottomInfo_1 = __importDefault(require("./ui/bottomInfo"));
const spotifyUtils_1 = require("./spotifyUtils");
class Client {
    constructor(ltPlayer) {
    ...
    connect(server) {
        ...
        if ((0, spotifyUtils_1.getCurrentTrackUri)() != "") {
            (0, spotifyUtils_1.forcePlayTrack)("");
            setTimeout(() => this.connect(server), 100);
            return;
        }
        this.server = server;
        this.connecting = true;
        this.ltPlayer.ui.renderBottomInfo(react_1.default.createElement(bottomInfo_1.default, { server: server, loading: true }));
        // this.ltPlayer.ui.menuItems.joinServer?.setName("Leave the server")
        this.socket = (0, socket_io_client_1.io)(server, {
            'secure': true,
        });
        this.socket.on("connect", () => {
            this.ltPlayer.ui.renderBottomInfo(react_1.default.createElement(bottomInfo_1.default, { server: server }));
            this.connecting = false;
            this.connected = true;
            this.ltPlayer.isHost = false;
            this.socket.emit("login", this.ltPlayer.settingsManager.settings.name, this.ltPlayer.version, (versionRequirements) => {
                var _a;
        ...
        this.socket.on("changeSong", (trackUri) => {
            if ((0, spotifyUtils_1.isListenableTrackType)((0, spotifyUtils_1.getTrackType)(trackUri)))
                this.ltPlayer.onChangeSong(trackUri);
        });
        this.socket.on("updateSong", (pause, milliseconds) => {
            if ((0, spotifyUtils_1.isListenableTrackType)())
                this.ltPlayer.onUpdateSong(pause, milliseconds);
        });
        this.socket.on("bottomMessage", (message) => {
            this.ltPlayer.ui.bottomMessage(message);
        });
        this.socket.on("windowMessage", (message) => {
            this.ltPlayer.ui.windowMessage(message);
        });
        this.socket.on("listeners", (clients) => {
            this.ltPlayer.ui.renderBottomInfo(react_1.default.createElement(bottomInfo_1.default, { server: server, listeners: clients }));
        });
        ...
        this.socket.on("songRequested", (trackUri, trackName, fromListener) => {
            this.ltPlayer.ui.songRequestPopup(trackName, fromListener, () => {
                (0, spotifyUtils_1.forcePlayTrack)(trackUri);
            });
        });
...
},{"./spotifyUtils":9,"./ui/bottomInfo":11,"react":49,"socket.io-client":50}],3:[function(require,module,exports){
"use strict";
...
(function listenTogetherMain() {
    ...
    const ltPlayer = new ltPlayer_1.default();
})();

},{"./ltPlayer":5}],4:[function(require,module,exports){
"use strict";
...
const patcher_1 = __importStar(require("./patcher"));
...
class LTPlayer {
    constructor() {
        ...
        this.patcher = new patcher_1.default(this);
        this.spotifyUtils = new spotifyUtils_1.SpotifyUtils(this);
        this.settingsManager = new settings_1.default();
        ...
        setInterval(() => {
            if (this.client.connected && (0, spotifyUtils_1.getTrackType)() === spotifyUtils_1.TrackType.Ad) {
    ...
    requestChangeSong(trackUri) {
        var _a;
        (_a = this.client.socket) === null || _a === void 0 ? void 0 : _a.emit("requestChangeSong", trackUri);
    }
    requestUpdateSong(paused, milliseconds) {
        var _a;
        let trackType = (0, spotifyUtils_1.getTrackType)();
        if ((0, spotifyUtils_1.isListenableTrackType)(trackType))
            (_a = this.client.socket) === null || _a === void 0 ? void 0 : _a.emit("requestUpdateSong", paused, milliseconds);
        else
            this.onUpdateSong(paused, trackType === spotifyUtils_1.TrackType.Ad ? undefined : milliseconds);
    }
    async requestSong(trackUri) {
        var _a;
        let data = await (0, spotifyUtils_1.getTrackData)(trackUri);
        if (data && data.error === undefined) {
            (_a = this.client.socket) === null || _a === void 0 ? void 0 : _a.emit("requestSong", trackUri, data.name || "UNKNOWN NAME");
        }
    }
    // Received
    onChangeSong(trackUri) {
        var _a;
        if (this.currentLoadingTrack === trackUri) {
            if (this.trackLoaded)
                (_a = this.client.socket) === null || _a === void 0 ? void 0 : _a.emit("changedSong", this.currentLoadingTrack);
        }
        else {
            (0, spotifyUtils_1.forcePlayTrack)(trackUri);
        }
    }
    onUpdateSong(pause, milliseconds) {
        if (milliseconds != undefined)
            patcher_1.OGFunctions.seekTo(milliseconds);
        if (pause) {
    ...
    // Events
    onSongChanged(trackUri) {
        var _a, _b;
        if (trackUri === undefined)
            trackUri = (0, spotifyUtils_1.getCurrentTrackUri)();
        ...
        if (this.client.connected) {
            if ((0, spotifyUtils_1.isListenableTrackType)((0, spotifyUtils_1.getTrackType)(trackUri))) {
                ...
                (_a = this.client.socket) === null || _a === void 0 ? void 0 : _a.emit("loadingSong", trackUri);
                ...
                (_b = this.client.socket) === null || _b === void 0 ? void 0 : _b.emit("changedSong", trackUri);
            }
        }
    }
    onLogin() {
...
},{"../package.json":1,"./client":2,"./patcher":6,"./settings":8,"./spotifyUtils":9,"./ui/ui":13}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.OGFunctions = void 0;
const liteEvent_1 = require("./liteEvent");
const spotifyUtils_1 = require("./spotifyUtils");
class Patcher {
    constructor(ltPlayer) {
        this.ltPlayer = ltPlayer;
        this.lastData = null;
        this.onTrackChanged = new liteEvent_1.LiteEvent();
    }
    ...
    patchAll() {
        ...
        Spicetify.Platform.PlayerAPI._cosmos.sub("sp://player/v2/main", (data) => {
            ...
            if (!data)
                return;
            if (((_b = (_a = this.lastData) === null || _a === void 0 ? void 0 : _a.track) === null || _b === void 0 ? void 0 : _b.uri) !== ((_c = data === null || data === void 0 ? void 0 : data.track) === null || _c === void 0 ? void 0 : _c.uri)) {
                console.log(data);
                this.onTrackChanged.trigger(((_d = data === null || data === void 0 ? void 0 : data.track) === null || _d === void 0 ? void 0 : _d.uri) || "");
            }
            this.lastData = data;
        });
        Spicetify.Platform.PlayerAPI._events._emitter.emitSync = (e, t) => {
            var _a;
            if (this.ltPlayer.client.connected && !this.ltPlayer.isHost) {
                if ((t === null || t === void 0 ? void 0 : t.action) === "play" && ((_a = t === null || t === void 0 ? void 0 : t.options) === null || _a === void 0 ? void 0 : _a.ltForced) !== true)
                    return;
                if ((t === null || t === void 0 ? void 0 : t.action) === "pause" && (0, spotifyUtils_1.isTrackPaused)())
                    return;
                if ((t === null || t === void 0 ? void 0 : t.action) === "resume" && !(0, spotifyUtils_1.isTrackPaused)())
                    return;
            }
            return exports.OGFunctions.emitSync(e, t);
        };
        Spicetify.Platform.PlayerAPI.play = (uri, origins, options) => {
            ...
            this.restrictAccess(() => exports.OGFunctions.play(uri, origins, options), () => {
                var _a;
                if ((options === null || options === void 0 ? void 0 : options.repeat) === undefined) { // Don't do anything if the function was executed by what plays the next song.
                    Spicetify.showNotification("Only the hosts can change songs!");
                    if (typeof (uri === null || uri === void 0 ? void 0 : uri.uri) === "string") {
                        if ((0, spotifyUtils_1.isListenableTrackType)((0, spotifyUtils_1.getTrackType)(uri.uri)))
                            this.ltPlayer.requestSong(uri.uri);
                        else if (typeof ((_a = options === null || options === void 0 ? void 0 : options.skipTo) === null || _a === void 0 ? void 0 : _a.uri) === "string" && (0, spotifyUtils_1.isListenableTrackType)((0, spotifyUtils_1.getTrackType)(options.skipTo.uri)))
                            this.ltPlayer.requestSong(options.skipTo.uri);
                    }
                }
            }, () => {
                this.ltPlayer.muteBeforePlay();
                exports.OGFunctions.play(uri, origins, options);
            }, this.ltPlayer.isHost || (options === null || options === void 0 ? void 0 : options.ltForced) === true);
        };
        Spicetify.Platform.PlayerAPI.pause = () => {
            this.restrictAccess(() => exports.OGFunctions.pause(), () => Spicetify.showNotification("Only the hosts can pause songs!"), () => {
                this.ltPlayer.requestUpdateSong(true, Spicetify.Player.getProgress());
            });
        };
        Spicetify.Platform.PlayerAPI.resume = () => {
            this.restrictAccess(() => exports.OGFunctions.resume(), () => Spicetify.showNotification("Only the hosts can resume songs!"), () => {
                this.ltPlayer.requestUpdateSong(false, Spicetify.Player.getProgress());
            });
        };
        Spicetify.Platform.PlayerAPI.skipToNext = (e) => {
            this.restrictAccess(() => exports.OGFunctions.skipToNext(e), () => Spicetify.showNotification("Only the hosts can change songs!"));
        };
        Spicetify.Platform.PlayerAPI.seekTo = (milliseconds) => {
            this.restrictAccess(() => exports.OGFunctions.seekTo(milliseconds), () => Spicetify.showNotification("Only the hosts can seek songs!"), () => {
                this.ltPlayer.requestUpdateSong(!Spicetify.Player.isPlaying(), milliseconds);
            });
        };
        Spicetify.Platform.PlayerAPI.skipToPrevious = (e) => {
            this.restrictAccess(() => exports.OGFunctions.skipToPrevious(e), () => Spicetify.showNotification("Only the hosts can change songs!"), () => {
                if (Spicetify.Player.getProgress() <= 3000)
                    exports.OGFunctions.skipToPrevious(e);
                else
    ...
    restrictAccess(ogFunc, restrictCallback, hostFunc, access) {
...
},{"./liteEvent":4,"./spotifyUtils":9}],7:[function(require,module,exports){
var css = ".lt-popup-button:enabled:active,\n.lt-popup-button:enabled:hover {\n  background-color: rgba(255,255,255,.1);\n  color: #fff;\n  text-decoration: none;\n}\n.lt-popup-button:disabled {\n  color: rgba(255,255,255,.5);\n}\n.lt-popup-button {\n  background: transparent;\n  border: 0;\n  border-radius: 2px;\n  cursor: default;\n  text-decoration: none;\n  -webkit-padding-end: 8px;\n  -webkit-box-pack: justify;\n  -ms-flex-pack: justify;\n  -webkit-box-align: center;\n  -ms-flex-align: center;\n  align-items: center;\n  color: rgba(255,255,255,.9);\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  gap: 8px;\n  height: 40px;\n  justify-content: space-between;\n  padding: 12px;\n  padding-inline-end: 8px;\n  position: relative;\n  text-align: start;\n  -webkit-user-select: none;\n  -moz-user-select: none;\n  -ms-user-select: none;\n  user-select: none;\n  width: 100%;\n}\n.lt-popup-text {\n  font-size: 16px;\n  overflow-y: visible;\n}\n"; (require("browserify-css").createStyle(css, { "href": "dist\\src\\public\\ui.css" }, { "insertAt": "bottom" })); module.exports = css;
},{"browserify-css":18}],8:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
class Settings {
    constructor() {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.SpotifyUtils = exports.forcePlay = exports.forcePlayTrack = exports.getTrackProgress = exports.isTrackPaused = exports.resumeTrack = exports.pauseTrack = exports.isTrack = exports.getTrackType = exports.isListenableTrackType = exports.getCurrentTrackUri = exports.getTrackData = exports.TrackType = void 0;
const patcher_1 = require("./patcher");
var TrackType;
(function (TrackType) {
    TrackType[TrackType["Ad"] = 0] = "Ad";
    TrackType[TrackType["Episode"] = 1] = "Episode";
    TrackType[TrackType["Track"] = 2] = "Track";
    TrackType[TrackType["NoTrack"] = 3] = "NoTrack";
    TrackType[TrackType["Unknown"] = 4] = "Unknown";
})(TrackType = exports.TrackType || (exports.TrackType = {}));
async function getTrackData(trackUri) {
    if (isTrack(trackUri))
...
function getCurrentTrackUri() {
    var _a;
    return ((_a = Spicetify.Platform.PlayerAPI._state.item) === null || _a === void 0 ? void 0 : _a.uri) || "";
}
exports.getCurrentTrackUri = getCurrentTrackUri;
function isListenableTrackType(trackType) {
    if (trackType === undefined)
        trackType = getTrackType();
    return trackType === TrackType.Episode || trackType === TrackType.Track;
}
exports.isListenableTrackType = isListenableTrackType;
function getTrackType(trackUri) {
    if (trackUri === undefined)
...
exports.getTrackType = getTrackType;
function isTrack(trackUri) {
    return (trackUri.match(/:/g) || []).length == 2;
}
exports.isTrack = isTrack;
function pauseTrack() {
    if (Spicetify.Player.isPlaying())
        patcher_1.OGFunctions.pause();
}
exports.pauseTrack = pauseTrack;
function resumeTrack() {
    if (!Spicetify.Player.isPlaying())
        patcher_1.OGFunctions.resume();
}
exports.resumeTrack = resumeTrack;
function isTrackPaused() {
    return !Spicetify.Player.isPlaying();
}
exports.isTrackPaused = isTrackPaused;
function getTrackProgress() {
    return Spicetify.Player.getProgress();
}
exports.getTrackProgress = getTrackProgress;
function forcePlayTrack(trackUri) {
    forcePlay({ uri: trackUri }, {}, {});
}
exports.forcePlayTrack = forcePlayTrack;
function forcePlay(uri, origins, options) {
    Spicetify.Platform.PlayerAPI.play(uri, origins, Object.assign(Object.assign({}, options), { ltForced: true }));
}
exports.forcePlay = forcePlay;
class SpotifyUtils {
    constructor(ltPlayer) {
        this.ltPlayer = ltPlayer;
        this.loadedInterval = null;
        this.timeoutLoadedCallback = null;
    }
    onTrackLoaded(trackUri, callback) {
        ...
        this.loadedInterval = setInterval(() => {
            var _a, _b, _c, _d;
            console.log(`check loaded: ${getCurrentTrackUri()}===${trackUri}   ${(_b = (_a = Spicetify.Platform.PlayerAPI._state) === null || _a === void 0 ? void 0 : _a.item) === null || _b === void 0 ? void 0 : _b.name}  ${!Spicetify.Platform.PlayerAPI._state.isBuffering}`);
            if (getCurrentTrackUri() === trackUri && ((_d = (_c = Spicetify.Platform.PlayerAPI._state) === null || _c === void 0 ? void 0 : _c.item) === null || _d === void 0 ? void 0 : _d.name) && !Spicetify.Platform.PlayerAPI._state.isBuffering) {
                if (this.loadedInterval)
                    clearInterval(this.loadedInterval);
                if (this.timeoutLoadedCallback)
                    clearTimeout(this.timeoutLoadedCallback);
...
},{"./patcher":6}],10:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = '<?xml version="1.0" encoding="UTF-8" standalone="no"?><!-- Generator: Gravit.io --><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="isolation:isolate" viewBox="0 0 48 48" width="48pt" height="48pt"><defs><clipPath id="_clipPath_f7CJYFCVBcPIpHV5DkgkHxC5QmJ6xHXd"><rect width="48" height="48"/></clipPath></defs><g clip-path="url(#_clipPath_f7CJYFCVBcPIpHV5DkgkHxC5QmJ6xHXd)"><rect width="48" height="48" style="fill:rgb(0,0,0)" fill-opacity="0"/><g style="isolation:isolate"><defs><linearGradient id="_lgradient_0" x1="0" y1="0.5" x2="1" y2="0.5"><stop offset="2.5%" style="stop-color:#1ED78A"/><stop offset="97.5%" style="stop-color:#4876E3"/></linearGradient></defs><path d="M 7.64 15.16 L 7.64 15.16 C 8.887 15.16 9.9 16.248 9.9 17.587 L 9.9 29.693 C 9.9 31.032 8.887 32.12 7.64 32.12 L 7.64 32.12 C 6.393 32.12 5.38 31.032 5.38 29.693 L 5.38 17.587 C 5.38 16.248 6.393 15.16 7.64 15.16 Z" style="stroke:none;fill:url(#_lgradient_0);stroke-miterlimit:10;"/><defs><linearGradient id="_lgradient_1" x1="0" y1="0.5" x2="1" y2="0.5"><stop offset="0%" style="stop-color:#C35151"/><stop offset="98.33333333333333%" style="stop-color:#BE7FDD"/></linearGradient></defs><path d="M 14.26 9 L 14.26 9 C 15.507 9 16.52 10.446 16.52 12.228 L 16.52 35.772 C 16.52 37.554 15.507 39 14.26 39 L 14.26 39 C 13.013 39 12 37.554 12 35.772 L 12 12.228 C 12 10.446 13.013 9 14.26 9 Z" style="stroke:none;fill:url(#_lgradient_1);stroke-miterlimit:10;"/><defs><linearGradient id="_lgradient_2" x1="0" y1="0.5" x2="1" y2="0.5"><stop offset="0%" style="stop-color:#C35151"/><stop offset="98.33333333333333%" style="stop-color:#BE7FDD"/></linearGradient></defs><path d="M 27.5 10.3 L 27.5 10.3 C 28.747 10.3 29.76 11.682 29.76 13.385 L 29.76 34.615 C 29.76 36.318 28.747 37.7 27.5 37.7 L 27.5 37.7 C 26.253 37.7 25.24 36.318 25.24 34.615 L 25.24 13.385 C 25.24 11.682 26.253 10.3 27.5 10.3 Z" style="stroke:none;fill:url(#_lgradient_2);stroke-miterlimit:10;"/><defs><linearGradient id="_lgradient_3" x1="0" y1="0.5" x2="1" y2="0.5"><stop offset="2.5%" style="stop-color:#1ED78A"/><stop offset="97.5%" style="stop-color:#4876E3"/></linearGradient></defs><path d="M 20.88 12.26 L 20.88 12.26 C 22.127 12.26 23.14 13.54 23.14 15.116 L 23.14 32.884 C 23.14 34.46 22.127 35.74 20.88 35.74 L 20.88 35.74 C 19.633 35.74 18.62 34.46 18.62 32.884 L 18.62 15.116 C 18.62 13.54 19.633 12.26 20.88 12.26 Z" style="stroke:none;fill:url(#_lgradient_3);stroke-miterlimit:10;"/><defs><linearGradient id="_lgradient_4" x1="0" y1="0.5" x2="1" y2="0.5"><stop offset="0%" style="stop-color:#C35151"/><stop offset="98.33333333333333%" style="stop-color:#BE7FDD"/></linearGradient></defs><path d="M 40.549 17.52 L 40.941 17.52 C 42.077 17.52 43 18.444 43 19.582 L 43 27.698 C 43 28.836 42.077 29.76 40.941 29.76 L 40.549 29.76 C 39.413 29.76 38.49 28.836 38.49 27.698 L 38.49 19.582 C 38.49 18.444 39.413 17.52 40.549 17.52 Z" style="stroke:none;fill:url(#_lgradient_4);stroke-miterlimit:10;"/><defs><linearGradient id="_lgradient_5" x1="0" y1="0.5" x2="1" y2="0.5"><stop offset="2.5%" style="stop-color:#1ED78A"/><stop offset="97.5%" style="stop-color:#4876E3"/></linearGradient></defs><path d="M 34.12 13.8 L 34.12 13.8 C 35.367 13.8 36.38 14.993 36.38 16.462 L 36.38 31.538 C 36.38 33.007 35.367 34.2 34.12 34.2 L 34.12 34.2 C 32.873 34.2 31.86 33.007 31.86 31.538 L 31.86 16.462 C 31.86 14.993 32.873 13.8 34.12 13.8 Z" style="stroke:none;fill:url(#_lgradient_5);stroke-miterlimit:10;"/></g><g style="isolation:isolate"><g style="isolation:isolate"/><g style="isolation:isolate"/></g></g></svg>';
...
function BottomInfo(props) {
    return react_1.default.createElement("div", { style: styles.textContainer }, !!props.server ? react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("span", { style: { maxHeight: '22px', overflow: 'hidden', maxWidth: '50%' } }, `Listen Together ${props.loading ? "trying to connect" : "connected"} to ${props.server}`),
        props.loading ? react_1.default.createElement(react_1.default.Fragment, null) : react_1.default.createElement("span", { style: { maxHeight: '22px', overflow: 'hidden', maxWidth: '50%' } },
            `Listeners: `,
            " ",
            props.listeners ? props.listeners.map((listener, i) => {
                ...
                return react_1.default.createElement("span", { key: i, title: title, style: { color: color } }, listener.name + (i !== props.listeners.length - 1 ? ", " : ""));
            }) : ""))
        : react_1.default.createElement(react_1.default.Fragment, null));
}
exports.default = BottomInfo;

},{"react":49}],12:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
var Popup;
(function (Popup) {
    class Textbox extends react_1.default.Component {
        constructor(props) {
            super(props);
        ...
        render() {
            return react_1.default.createElement("tr", null,
                react_1.default.createElement("td", { style: { paddingBottom: this.props.bottomSpace || 20 } },
                    react_1.default.createElement("div", { style: styles.center }, this.props.name)),
                react_1.default.createElement("td", { style: { paddingBottom: this.props.bottomSpace || 20 } },
                    react_1.default.createElement("div", { style: styles.center },
                        react_1.default.createElement("input", { onInput: (e) => {
                                if (this.props.onInput)
                                    this.props.onInput(e.currentTarget.value);
                            }, className: 'main-playlistEditDetailsModal-titleInput', type: 'text', defaultValue: this.props.defaultValue || "", placeholder: this.props.example || "" }))));
        }
    }
    ...
    class Text extends react_1.default.Component {
        ...
        render() {
            return react_1.default.createElement("tr", null,
                react_1.default.createElement("td", { colSpan: 2, style: { paddingBottom: this.props.bottomSpace || 20 } },
                    react_1.default.createElement("div", { style: this.props.centered || true ? styles.center : {} }, this.props.text)));
        }
    }
    Popup.Text = Text;
    class Button extends react_1.default.Component {
        ...
        render() {
            return react_1.default.createElement("tr", null,
                react_1.default.createElement("td", { colSpan: 2, style: { paddingBottom: this.props.bottomSpace || 10 } },
                    react_1.default.createElement("button", { className: "lt-popup-button", onClick: () => { if (this.props.onClick)
                            this.props.onClick(); }, disabled: this.props.disabled },
                        react_1.default.createElement("span", { className: "lt-popup-text", dir: "auto" }, this.props.text))));
        }
    }
    Popup.Button = Button;
    function close() {
    ...
    Popup.close = close;
    function create(title, closed, buttonNames, content) {
        let buttons = [];
        buttonNames.forEach((btnName) => {
            buttons.push(react_1.default.createElement("button", { className: 'main-buttons-button main-button-secondary main-playlistEditDetailsModal-save', style: styles.button, type: 'button', onClick: () => {
                    closed(btnName);
                } }, btnName));
        });
        Spicetify.PopupModal.display({
            title: title,
            content: (react_1.default.createElement("div", { style: styles.center },
                react_1.default.createElement("table", { style: { width: '100%' } },
                    content.map((elem) => {
                        return react_1.default.createElement(react_1.default.Fragment, null, elem);
                    }),
                    react_1.default.createElement("tr", null,
                        react_1.default.createElement("td", { colSpan: 2 },
                            react_1.default.createElement("div", { style: styles.center },
                                react_1.default.createElement("table", { style: { width: '100%' } },
                                    react_1.default.createElement("tr", null, buttons.map((btn) => {
                                        return react_1.default.createElement("td", null,
                                            react_1.default.createElement("div", { style: styles.center }, btn));
                                    })))))))))
        });
    }
    Popup.create = create;
...
},{"react":49}],13:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
const bottomInfo_1 = __importDefault(require("./bottomInfo"));
const popup_1 = require("./popup");
const ListenTogetherIcon_1 = __importDefault(require("./ListenTogetherIcon"));
const package_json_1 = __importDefault(require("../../package.json"));
const css = require('../public/ui.css');
class UI {
    constructor(ltPlayer) {
        this.ltPlayer = ltPlayer;
        this.bottomInfoContainer = null;
        new Spicetify.Topbar.Button("Listen Together", ListenTogetherIcon_1.default, () => this.openMenu());
        let loop = setInterval(() => {
            ...
            if (playingBar) {
                ...
                this.renderBottomInfo(react_1.default.createElement(bottomInfo_1.default, { server: "" }));
            }
        }, 100);
    }
    songRequestPopup(trackName, fromListener, permitted) {
        popup_1.Popup.create("Listen Together", (btn) => { if (btn === "Play")
            permitted(); popup_1.Popup.close(); }, ["Play"], [
            react_1.default.createElement(popup_1.Popup.Text, { text: `${fromListener} wants to play "${trackName}".` })
        ]);
    }
    openMenu() {
        popup_1.Popup.create("Listen Together", () => popup_1.Popup.close(), [], [
            react_1.default.createElement(popup_1.Popup.Button, { text: (this.ltPlayer.client.connected || this.ltPlayer.client.connecting) ? "Leave the server" : "Join a server", onClick: () => this.onClickJoinAServer() }),
            react_1.default.createElement(popup_1.Popup.Button, { text: (this.ltPlayer.isHost ? "Stop hosting" : "Request host"), onClick: () => this.onClickRequestHost(), disabled: !this.ltPlayer.client.connected }),
            react_1.default.createElement(popup_1.Popup.Button, { text: "About", onClick: () => this.onClickAbout() }),
        ]);
    }
    windowMessage(message) {
        popup_1.Popup.create("Listen Together", () => popup_1.Popup.close(), ["OK"], [
            react_1.default.createElement(popup_1.Popup.Text, { text: message })
        ]);
    }
    ...
    disconnectedPopup() {
        popup_1.Popup.create("Listen Together", (btn) => {
            if (btn === "Reconnect") {
                this.ltPlayer.client.connect();
            }
            popup_1.Popup.close();
        }, ["Reconnect"], [
            react_1.default.createElement(popup_1.Popup.Text, { text: "Disconnected from the server." })
        ]);
    }
    joinAServerQuick(address) {
    ...
    onClickRequestHost() {
        ...
        if (this.ltPlayer.client.connected) {
            if (this.ltPlayer.isHost) {
                (_a = this.ltPlayer.client.socket) === null || _a === void 0 ? void 0 : _a.emit("cancelHost");
                popup_1.Popup.close();
            }
            else {
                this.requestHostPopup((password) => {
                    var _a;
                    if (!!password) {
                        (_a = this.ltPlayer.client.socket) === null || _a === void 0 ? void 0 : _a.emit("requestHost", password);
                    }
                    popup_1.Popup.close();
                });
            }
    ...
    onClickAbout() {
        popup_1.Popup.create("Listen Together", () => { popup_1.Popup.close(); }, [], [
            react_1.default.createElement(popup_1.Popup.Text, { text: `Listen Together v${package_json_1.default.version} created by FlafyDev`, centered: false }),
            react_1.default.createElement(popup_1.Popup.Button, { text: "Github", onClick: () => window.location.href = "https://github.com/FlafyDev/spotify-listen-together" }),
        ]);
    }
    joinServerPopup(callback) {
        let address = "";
        let name = "";
        popup_1.Popup.create("Listen Together", (btn) => callback(btn, address, name), ["Join", "Host a server"], [
            react_1.default.createElement(popup_1.Popup.Textbox, { name: "Server address", example: "https://www.server.com/", defaultValue: this.ltPlayer.settingsManager.settings.server, onInput: (text) => {
                    address = text;
                } }),
            react_1.default.createElement(popup_1.Popup.Textbox, { name: "Your name", example: "Joe", defaultValue: this.ltPlayer.settingsManager.settings.name, onInput: (text) => {
                    name = text;
                } }),
        ]);
    }
    requestHostPopup(callback) {
        let password = "";
        popup_1.Popup.create("Listen Together", () => callback(password), ["Request"], [
            react_1.default.createElement(popup_1.Popup.Text, { text: "Request host" }),
            react_1.default.createElement(popup_1.Popup.Textbox, { name: "Password", onInput: (text) => password = text })
        ]);
    }
    renderBottomInfo(bottomInfo) {
        if (this.bottomInfoContainer) {
            this.bottomInfoContainer.innerHTML = (0, server_1.renderToStaticMarkup)(bottomInfo);
        }
    }
}
exports.default = UI;

},{"../../package.json":1,"../public/ui.css":7,"./ListenTogetherIcon":10,"./bottomInfo":11,"./popup":12,"react":49,"react-dom/server":46}],14:[function(require,module,exports){
...
},{"base64-js":17,"buffer":19,"ieee754":38}],20:[function(require,module,exports){
...
},{"./common":21,"_process":43}],21:[function(require,module,exports){
...
},{"./socket.js":24,"./transport.js":25,"./transports/index.js":26,"./util.js":32}],24:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./transports/index.js":26,"./util.js":32,"@socket.io/component-emitter":14,"debug":20,"engine.io-parser":36,"parseqs":41,"parseuri":42}],25:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./util.js":32,"@socket.io/component-emitter":14,"debug":20,"engine.io-parser":36}],26:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./polling-xhr.js":27,"./websocket.js":30}],27:[function(require,module,exports){
"use strict";
/* global attachEvent */
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
...
},{"../globalThis.js":22,"../util.js":32,"./polling.js":28,"./xmlhttprequest.js":31,"@socket.io/component-emitter":14,"debug":20}],28:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"../transport.js":25,"debug":20,"engine.io-parser":36,"parseqs":41,"yeast":58}],29:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"../globalThis.js":22}],30:[function(require,module,exports){
(function (Buffer){(function (){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
...
},{"../transport.js":25,"../util.js":32,"./websocket-constructor.js":29,"buffer":19,"debug":20,"engine.io-parser":36,"parseqs":41,"yeast":58}],31:[function(require,module,exports){
"use strict";
...
},{"../globalThis.js":22,"has-cors":37}],32:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./globalThis.js":22}],33:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./commons.js":33,"base64-arraybuffer":16}],35:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const commons_js_1 = require("./commons.js");
...
},{"./commons.js":33}],36:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./decodePacket.js":34,"./encodePacket.js":35}],37:[function(require,module,exports){
...
},{"_process":43,"object-assign":40,"react":49}],45:[function(require,module,exports){
/** @license React v17.0.2
...
},{"object-assign":40,"react":49}],46:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"./cjs/react-dom-server.browser.development.js":44,"./cjs/react-dom-server.browser.production.min.js":45,"_process":43}],47:[function(require,module,exports){
(function (process){(function (){
/** @license React v17.0.2
...
},{"_process":43,"object-assign":40}],48:[function(require,module,exports){
/** @license React v17.0.2
...
},{"object-assign":40}],49:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"./cjs/react.development.js":47,"./cjs/react.production.min.js":48,"_process":43}],50:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./manager.js":51,"./socket.js":53,"./url.js":54,"debug":20,"socket.io-parser":56}],51:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    Object.defineProperty(o, k2, { enumerable: true, get: function() { return m[k]; } });
...
},{"./on.js":52,"./socket.js":53,"@socket.io/component-emitter":14,"backo2":15,"debug":20,"engine.io-client":23,"socket.io-parser":56}],52:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.on = void 0;
...
},{"./on.js":52,"@socket.io/component-emitter":14,"debug":20,"socket.io-parser":56}],54:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"debug":20,"parseuri":42}],55:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./binary.js":55,"./is-binary.js":57,"@socket.io/component-emitter":14,"debug":20}],57:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
